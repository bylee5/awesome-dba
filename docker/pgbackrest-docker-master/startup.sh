...
ag_ctl -D $PBHOME_2_06_AGDATA start
ag_ctl -D $PBHOME_1_29_AGDATA start


for i in 5432 5433 5434
do
	StartTime=$(date +%s)
...
# pgbackrest v2.06
/home/agens/pgbackrest_2_06/pgbackrest --config=/home/agens/pgbackrest_2_06/pgbackrest.conf --stanza=agens_2_06 --log-level-console=info stanza-create

/home/agens/pgbackrest_2_06/pgbackrest --config=/home/agens/pgbackrest_2_06/pgbackrest.conf --stanza=agens_2_06 --log-level-console=info backup

ag_ctl -D $PBHOME_2_06_AGDATA stop

rm -rf $PBHOME_2_06_AGDATA/*

/home/agens/pgbackrest_2_06/pgbackrest --config=/home/agens/pgbackrest_2_06/pgbackrest.conf --stanza=agens_2_06 --log-level-console=info restore

ag_ctl -D $PBHOME_2_06_AGDATA start

if [ 2 -eq $(agens -p 5433 -c "set graph_path to pb; match (n) return count(n)" | head -n3 | tail -n1 | grep -o '[0-9]') ]; then
	echo "v2.06 succeeded"
else
	echo "v2.06 failed"
	exit 1
fi
